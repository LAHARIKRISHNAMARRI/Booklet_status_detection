...
# Step 2: Add 'Status' based on Collected and Corrected
try:
...
def send_telegram_alert(message):
    ...
    params = {'chat_id': chat_ids, 'text': message}
...
# ---------------------------
# For modeling, we will predict the Status.
...
# In a more sophisticated model, you might include additional features.
X = df[['Collected']]  # Feature(s)
y = df['Status_Num']   # Target
